public class ChatBot {
    ...
    // constructor
    public ChatBot(String chatBotName, int faveNum, String faveLetter) {
        name = chatBotName;
        number = faveNum;
        letter = faveLetter;
    }
    ...
    public void favoriteLetter(String yourLetter) {
        System.out.println("My favorite letter is " + letter);
        System.out.println("Your favorite letter is " + yourLetter);
    }
